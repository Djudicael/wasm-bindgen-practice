use std::{f64, ops::Add};
use wasm_bindgen::{JsCast, JsValue, Clamped, prelude::wasm_bindgen};
use web_sys::{Document, CanvasRenderingContext2d, ImageData};
pub fn run_canvas(document: &Document) {
